...
game = open('data/random_battle.txt', 'r').read().splitlines()
move_dex = json.load(open('data/moves_dex.json'))
# data = json.load(open('data/data.json'))
species_dex = json.load(open('data/species_dex.json'))
ability_dex = json.load(open('data/abilitydex.json'))
typechart = json.load(open('data/typechart_dex.json'))
random_sets = requests.request("GET", 'https://raw.githubusercontent.com/smogon/pokemon-showdown/master/data/random-sets.json').json()
...
STATUS_MOVES = [move['id'] for move in move_dex.values() if move['category'] == 'Status']
